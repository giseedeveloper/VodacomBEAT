...
class GenerateAudioPreviewJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($subscription === null) {
            Log::error("GenerateAudioPreviewJob: subscription {$this->subscriptionId} not found");
            return;
        }

        BeatAudioService::generatePreview($subscription, $this->voiceId, $this->requestedBy);
    }
